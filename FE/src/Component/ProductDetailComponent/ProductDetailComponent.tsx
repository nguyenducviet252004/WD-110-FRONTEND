                          ...
                          style={{
                            ...
                            border:
                              selectedColor === color.name_color
                                ? "1px solid rgb(137, 197, 219)"
                                : "1px solid gray",
                            borderRadius: "8px",
                            backgroundColor: "white",
                            // background: selectedColor === color.name_color ? 'rgb(137, 182, 219)' : 'none',
                            margin: "0 5px 0 0",
                            color:
                              selectedColor === color.name_color
                                ? "rgb(137, 186, 219)"
